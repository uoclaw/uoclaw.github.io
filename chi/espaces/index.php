...
?>
	...
	<ul>
	  <li>英联邦国家
	    <ul>
	      <li><a href="wealth/carte.php">成员国地理分布图示</a> </li>
	      <li><a href="wealth/commonwealth.php">成员国及法律体系字母顺序列表</a></li>
	      </ul>
	    </li>
	  <li>法语联盟国家
        <ul>
          <li><a href="franco/carte.php">成员国地理分布图示</a> </li>
          <li><a href="franco/francophonie.php">成员国及法律体系字母顺序列表</a></li>
        </ul>
	  </li>
	  <li>阿拉伯教育、文化及科学组织（ALECSO）
	      <ul>
	        <li><a href="alecso/carte.php">成员国地理分布图示 </a></li>
	        <li><a href="alecso/alecso.php">成员国及法律体系字母顺序列表</a></li>
          </ul>
	    </li>
	  <li>伊比利亚-美洲教育、科学及文化组织（OEI）
	      <ul>
	        <li><a href="oei/carte.php">成员国地理分布图示</a> </li>
	        <li><a href="oei/oei.php">成员国及法律体系字母顺序列表 </a></li>
          </ul>
	    </li>
	  <li>其他语言界
        <ul>
          <li><a href="autres/turksoy.php">土耳其文化艺术共同管理机构</a>（TURKSOY） </li>
          <li><a href="autres/cplp.php">葡萄牙语国家共同体</a>（CPLP） </li>
          <li><a href="autres/trois.php">三语界</a>(3EL)</li>
          <li><a href="autres/unilat.php">拉丁语国家联盟</a>（UNILAT） </li>
          </ul>
	  </li>
	  <li><a href="biblio.php">参考书目</a> </li>
	  </ul>
	<!-- InstanceEndEditable -->
</div>
