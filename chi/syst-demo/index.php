...
?>
	...
	<h2>按人口统计划分</h2>
	<ul>
	  <li><a href="index-alpha.php">政治实体字母顺序索引 - 按人口与对应法律体系</a></li>
	  <li><a href="index-syst.php">按法律体系及其不同组合的人口划分<BR>
	  </a></li>
	  <li><a href="index-tableau.php">不同法律体系人口百分比统计表</a></li>
	  <li><a href="graph.php">法律体系所占世界人口（百分比）对比图示</a> </li>
	</ul>
	<p>&nbsp;</p>
	<!-- InstanceEndEditable -->
</div>
