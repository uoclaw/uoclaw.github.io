...
?>
    ...
    <h2>不同语种按法律体系分类     </h2>
    <ul>
      <li><a href="classification/dcivil.php">单一制民法系和具有民法系传统的混合法系</a> </li>
      <li><a href="classification/claw.php">单一制普通法系和具有普通法系传统的混合法系</a></li>
      <li><a href="classification/musulman.php">单一制穆斯林法系和具有穆斯林法系传统的混合法系</a></li>
      <li><a href="classification/coutumier.php">单一制习惯法系和具有习惯法系传统的混合法系</a></li>
      <li><a href="classification/mixtes.php">混合法系</a> </li>
    </ul>
	<!-- InstanceEndEditable -->
</div>
