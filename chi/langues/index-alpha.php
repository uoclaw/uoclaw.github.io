...
?>
	...
	<h2>政治实体、法律体系和语言对应字母顺序索引</h2>
	<table cellspacing="3" cellpadding="3" width="100%">
      <tr>
        <td width="40%"><div align="center"><strong>政治实体</strong></div></td>
        <td width="30%"><div align="center"><strong> 法律体系</strong></div></td>
        <td width="30%"><div align="center"><strong>官方语言</strong></div></td>
      </tr>
      ...
      <tr>
        <td>缅甸</td>
        <td>混合法</td>
        <td><a href="http://baike.baidu.com/view/36444.htm" target="_blank">缅甸语</a></td>
      </tr>
      <tr>
        <td>纳米比亚</td>
        <td>混合法</td>
      ...
      <tr>
        <td>巴基斯坦 </td>
        <td>混合法</td>
        <td><a href="http://baike.baidu.com/view/110916.htm" target="_blank">乌尔都语、英语</a></td>
      </tr>
      <tr>
        <td>帕劳</td>
        <td>普通法</td>
      ...
      <tr>
        <td>新加坡</td>
        <td>混合法</td>
        <td>英语、汉语、马来语、泰米尔语</td>
      </tr>
      <tr>
        <td>斯洛伐克</td>
        <td>民法</td>
        <td><a href="http://baike.baidu.com/view/262050.htm" target="_blank">斯洛伐克语</a></td>
      </tr>
      <tr>
        <td>斯洛文尼亚</td>
        <td>民法</td>
      ...
      <tr>
        <td>瑞典</td>
        <td>民法</td>
        <td><a href="http://baike.baidu.com/view/122478.htm" target="_blank">瑞典语</a></td>
      </tr>
      <tr>
        <td>瑞士</td>
        <td>民法</td>
