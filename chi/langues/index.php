...
?>
	...
	<h2>语言与法律体系</h2>
	<ul>
	  <li><a href="intro.php">序言 </a></li>
	  <li><a href="index-alpha.php">政治实体、法律体系和语言对应字母顺序索引</a></li>
	  <li><a href="index-syst.php">不同语种按法律体系分类</a></li>
	  <li><a href="tab-langues-officielles.php">官方语言按不同法律体系分类统计表</a></li>
	  <li><a href="graph.php">不同语种按法律体系分布图示（语种和百分比）</a></li>
	  <li><a href="biblio.php">官方语言参考书目</a></li>
	</ul>
	<!-- InstanceEndEditable -->
</div>
