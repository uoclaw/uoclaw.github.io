...
?>
	...
	<h2>提示</h2>
	<h3>免责条款 </h3>
	<p>本站的所有信息将会被尽可能仔细和审慎的集中更新或者修正。但是，本网站内容所涉及的有关信息及其解释不应被视为法律的或者职业的依据。</p>
	<p>渥太华大学、法学院、民法系以及本站作者对其内容不承担任何责任。</p>
	<h3>著作权 </h3>
	<p>本站各项材料及内容受著作权保护，任何私人的、教学的或者非盈利性的用途不必申请使用许可，但须标明信息来源由渥太华大学法学院民法系提供并注明相关网址。</p>
	<p>所有其他用途必须以书面方式提前向渥太华大学法学院民法系申请使用许可，联系办法可发送邮件至：<a href="mailto:dcivil@uottawa.ca">dcivil@uottawa.ca</a> </p>
	<!-- InstanceEndEditable -->
</div>
