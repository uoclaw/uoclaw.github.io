...
?>
	...
	<h2>政治实体和法律体系对应分类 </h2>
	<ul>
	  <li><a href="class-poli/droit-civil.php">单一制民法系和具有民法系传统的混合制法系</a> </li>
	  <li><a href="class-poli/common-law.php">单一制普通法系和具有普通法系传统的混合制法系</a> </li>
	  <li><a href="class-poli/droit-musulman.php">单一制穆斯林法系和具有穆斯林法系传统的混合制法系</a> </li>
	  <li><a href="class-poli/droit-coutumier.php">单一制习惯法系和具有习惯法系传统的混合制法系</a> </li>
	  <li><a href="class-poli/sys-mixtes.php">混合制法</a></li>
	  </ul>
	<!-- InstanceEndEditable -->
</div>
