...
?>
	...
	<h2>界国内生产总值按法律体系划分统计表（美元单位和百分比）</h2>
	<ul>
	  <li><a href="tableau-repartition-pib.php">按法律体系划分世界国内生产总值分配统计表（美元和百分比）</a></li>
	  <li><a href="tableau-dcivil-claw.php">民法系和普通法系所占世界国内生产总值表（美元和百分比）</a></li>
	  <li><a href="tableau-musulman.php">穆斯林法系所占世界国内生产总值表（美元和百分比）</a></li>
	  <li><a href="tableau-coutumier.php">习惯法系所占世界国内生产总值表（美元和百分比）</a></li>
	  <li><a href="tableau-mixtes.php">混合法系所占世界国内生产总值表（美元和百分比）</a></li>
	  </ul>
	<!-- InstanceEndEditable -->
</div>
