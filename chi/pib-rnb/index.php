...
?>
	...
	<h2>按世界国内生产总值和人均国民生产总值划分</h2>
	<ul>
	  <li><a href="index-alpha.php">政治实体按照对应法律体系、国内生产总值和人均国民生产总值字母顺序索引</a></li>
	  <li><a href="index-syst.php">按法律体系及其组成划分世界国内生产总值及人均国民生产总值</a></li>
	  <li><a href="pib/index-pib.php">世界国内生产总值按法律体系划分统计表（美元单位和百分比） </a></li>
	  <li><a href="graph_pib.php">法律体系所占世界国内生产总值对比图示（百分比） </a></li>
	  <li><a href="rnb/index-rnb.php">平均人均国民生产总值按法律体系划分对比表</a></li>
	  <li><a href="graph_rnb.php">法律体系所占人均国民生产总值对比图示（图册法和美元单位） </a></li>
	</ul>
	<!-- InstanceEndEditable -->
</div>
