...
?>
	...
	<h2>政治实体按照对应法律体系、国内生产总值和人均国民生产总值字母顺序索引</h2>
	<table cellspacing="3" cellpadding="3" width="100%">
      <tr>
        <td width="40%"><strong>政治实体</strong></td>
        <td width="20%"><strong> 法律体系</strong></td>
        <td width="20%"><strong>国内生产总值(单位：十亿美元)</strong></td>
        <td width="20%"><strong>人均国民生产总值(图册法)美元(a)</strong></td>
      </tr>
      <tr>
        <td>&nbsp;</td>
        <td>&nbsp;</td>
      ...
      <tr>
		...
		<h4>信息来源:</h4>
		<p>(I)    除非有特别脚注标示，所使用的基础统计信息来源于“世界银行 KEY DEVELOPMENT DATA &amp;    STATISTICS”2006，并由如下的信息来源加以补充：</p>
		<ol>
		  <li>Pocket World in Figures 2007, The Economist, 2007 Edition</li>
		  <li>1    251.5 - 273.6 = 977.9</li>
		  <li>The    Scottish Government Statistics 2004 (网站）</li>
		  <li>13    201.8 - 168.2 = 13 033.6</li>
		  <li>CIA,    the World Fact Book 2007 (网站）</li>
		  <li>同注（5）</li>
		  <li>U.S. Census Bureau of Economic Analysis 2005（网站）</li>
		  <li>Institut de la Statistique du Québec, le Québec, chiffre en    main, Québec 2007（网站）</li>
		  <li>2 345    - 166.3 = 2 178.7</li>
	  </ol>
		  <ol type="a">
	      <li>Revenu National Brut per capita, Atlas Method, World    Bank, 同注(I)</li>
	      <li>CIA,    the World Fact Book 2007 PIB per capita(网站）</li>
	      <li> Pocket World in Figures 2007, The Economist, 2007 Edition    (PIB per capita)</li>
	      <li>同注（b）</li>
	      <li>The Scottish Government Statistics PIB per capita 2004 （网站）</li>
	      <li> 同注（b）</li>
	      <li>同注（b）</li>
	      <li>同注（b）</li>
	      <li> U.S. Census Bureau, Bureau of Economic Analysis 2005 PIB    per capita （网站）</li>
	      <li>同注（b）</li>
	      <li>Institut de la Statistique du Québec, le Québec, chiffre en    main, Québec 2007 PIB per capita  (网站）</li>
	  </ol>
		  <p>(II)    对于附属于某宗主国的政治实体，除非有特别注释，其统计被包括在对应的宗主国的统计内</p>
	<!-- InstanceEndEditable -->
</div>
