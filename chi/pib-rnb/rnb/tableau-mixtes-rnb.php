...
?>
	...
	<h2>混合法系人均国民生产总值平均值表</h2>
	<table cellspacing="3" cellpadding="3" width="100%">
      <tr>
        <td width="50%"><div align="center"><strong>法律体系</strong></div></td>
        <td><div align="right"><strong>国内生产总值 （美元）（图册法）</strong></div></td>
      </tr>
      ...
      <tr>
        <td><strong>人均国民生产总值平均值</strong></td>
        <td><div align="right"><strong>8 821</strong></div></td>
      </tr>
    </table>
	<!-- InstanceEndEditable -->
</div>
