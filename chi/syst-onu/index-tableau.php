...
?>
	...
	<h2><a href="tab-regroupement.php">联合国成员国按其法律体系及混合构成分类统计表(数量及百分比) 
	  </a></h2>
	<ul>
      <li><a href="tab-regroupement.php#civil">民法系 </a></li>
      <li><a href="tab-regroupement.php#common">普通法系</a></li>
      <li><a href="tab-regroupement.php#musulman">穆斯林法系</a></li>
      <li><a href="tab-regroupement.php#coutumier">习惯法系</a></li>
      <li><a href="tab-regroupement.php#mixte">混合法系</a></li>
	</ul>
	<!-- InstanceEndEditable -->
</div>
