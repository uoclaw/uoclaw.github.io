...
<html lang="en"><!-- InstanceBegin template="/Templates/en-home-page.dwt" codeOutsideHTMLIsLocked="false" -->
...
<div id="main-content">
	...
	<param name="movie" value="logo2.swf" /><param name="quality" value="high" /><param name="bgcolor" value="#ffffff" />	<embed src="logo2.swf" width="550" height="550" align="middle" quality="high" bgcolor="#ffffff" allowScriptAccess="sameDomain" allowFullScreen="false" type="application/x-shockwave-flash" pluginspage="http://www.macromedia.com/go/getflashplayer" />
	</object></td>
	<td><h1><A href="/fra/index.php">Français</A> </h1>
	  <h1><A href="/rus/index.php">Русский</A> </h1>
	  <h1> <A href="/ara/index.php">عربي</A></h1></td>
	</tr>
	</table>
