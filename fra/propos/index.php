...
<meta name="keywords" content="Avant, Propos">
...
<!-- InstanceBeginEditable name="pageLinks" -->
	<ul id="page-links">
		...
		<li><a id="section-home" href="http://www.juriglobe.uottawa.ca/fra/index.php">Retourner à la page d'accueil</a></li>
	</ul>
<!-- InstanceEndEditable -->
	<!-- /#page-links -->
...
?>
	...
	<h2>Avant-propos
		...
		<ul>
			<li><a href="edition1.php">1<sup>re</sup> édition 1999</a></li>
			<li><a href="edition2.php">2<sup>e</sup> édition 2008</a></li>		
		</ul>
	<!-- InstanceEndEditable -->
</div>
