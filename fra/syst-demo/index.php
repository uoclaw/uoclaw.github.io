...
?>
	...
	<h2>Systèmes juridiques et répartition démographique</h2>
	<ul>
          <li> <a href="index-alpha.php">Index alphabétique des entités politiques, populations et systèmes juridiques correspondants</a></li>
          <li> <a href="index-syst.php">Répartition démographique selon les systèmes juridiques et leurs diverses composantes </a></li>
        <li><a href="index-tableau.php">Tableaux statistiques de répartition démographique selon les systèmes juridiques</a></li>
          <li> <a href="graph.php">Graphique comparatif de la répartition des populations (en %) par systèmes juridiques</a></li>
      </ul>
	<!-- InstanceEndEditable -->
</div>
