...
?>
	...
	<h2>Pourcentage de la  population mondiale des systèmes du droit musulman </h2>
	<table cellspacing="0" cellpadding="3">
      <tr>
        <td width="343"><p> SYSTÈMES MIXTES DE COMMON LAW, <br>
      ...
      <tr>
        <td width="343"><p> SYSTÈMES MIXTES DE DROIT CIVIL <br>
        ET DE DROIT MUSULMAN </p></td>
      ...
      <tr>
        <td width="343"><p> MONOSYSTÈMES DE DROIT MUSULMAN </p></td>
        <td width="293"><p align="right"><strong> 0.85 % </strong></p></td>
      </tr>
      <tr>
        <td width="343"><p> SYSTÈMES MIXTES DE COMMON LAW, DE DROIT CIVIL, DE DROIT MUSULMAN ET DE DROIT COUTUMIER </p></td>
        <td width="293"><p align="right"><strong> 0.48 % </strong></p></td>
      </tr>
      <tr>
        <td width="343"><p> SYSTÈME MIXTE DE DROIT CIVIL, DE COMMON LAW, DE DROIT JUIF ET DE DROIT MUSULMAN </p></td>
        <td width="293"><p align="right"><strong> 0.11 % </strong></p></td>
      </tr>
      <tr>
        <td width="343"><p> SYSTÈME MIXTE DE DROIT MUSULMAN ET DE DROIT COUTUMIER </p></td>
        <td width="293"><p align="right"><strong> 0.07 % </strong></p></td>
      </tr>
      <tr>
        <td width="343"><p><strong> TOTAL EN % DES POPULATIONS AVEC MONOSYSTÈMES OU SYSTÈMES MIXTES DE DROIT MUSULMAN </strong></p></td>
        <td width="293"><p align="right"><strong> 35.04 % </strong></p></td>
      </tr>
      <tr>
        <td width="343"><p><strong> POPULATION MONDIALE </strong></p></td>
