...
?>
	...
	<h2>Tableaux statistiques de répartition démographique selon les systèmes juridiques
	  </h2>
	<ul>
      <li><a href="tableau-popu.php">Répartition de la population mondiale (en %) selon les systèmes juridiques et leurs diverses composantes</a></li>
      <li><a href="tableau-dcivil-claw.php">Pourcentage de  la population mondiale des systèmes de droit civil et de common law</a> </li>
      <li><a href="tableau-musul.php">Pourcentage de  la population mondiale des systèmes de droit musulman</a> </li>
      <li><a href="tableau-coutumier.php">Pourcentage de  la population mondiale des systèmes de droit coutumier</a> </li>
      <li><a href="tableau-mixte.php">Pourcentage de  la population mondiale des systèmes de droit mixte</a></li>
    </ul>
	<!-- InstanceEndEditable -->
</div>
