...
?>
	...
	<h2>Administration  Commune des Cultures et des Arts Turcs (TURKSOY<em>)</em></h2>
	<p>	  Regroupe  la Turquie,  5 États turcophones et  8 autres régions turcophones dans diverses parties du monde*.  <br>
	  Siège&nbsp;:  Ankara. <br>
	  Site  web&nbsp;: <a href="http://www.turksoy.org/">www.turksoy.org</a></p>
	<p><strong>Systèmes juridiques de la Turquie et des  5 autres États</strong><strong> </strong>:  droit civil.</p>
	<table border="0" cellspacing="3" cellpadding="3">
      <tr>
        <td width="293" valign="top"><p>Azerbaïdjan</p></td>
        <td width="293" valign="top"><p>Civiliste</p></td>
      </tr>
      <tr>
        <td width="293" valign="top"><p>Kazakhstan</p></td>
        <td width="293" valign="top"><p>Civiliste</p></td>
      </tr>
      <tr>
        <td width="293" valign="top"><p>Kirghizstan</p></td>
        <td width="293" valign="top"><p>Civiliste</p></td>
      </tr>
      <tr>
        <td width="293" valign="top"><p>Ouzbékistan</p></td>
        <td width="293" valign="top"><p>Civiliste</p></td>
      </tr>
      <tr>
        <td width="293" valign="top"><p>Turkménistan</p></td>
        <td width="293" valign="top"><p>Civiliste</p></td>
      </tr>
      <tr>
        <td width="293" valign="top"><p>Turquie</p></td>
        <td width="293" valign="top"><p>Civiliste</p></td>
      </tr>
    </table>
	<p>* Altai, Baskurdistan , Saha (Yakut),  Tataristan, Tiva (régions de la Fédération de<br>
	    Russie),Hakas (région de la Moldavie)  et Gagavuz Yeri (région de l’Ouzbékistan)<br>
      sont de tradition civiliste.</p>
	<p> *
	  KKTC (région nord de Chypre) est de droit mixte&nbsp;: common law/civiliste.</p>
	<!-- InstanceEndEditable -->
</div>
