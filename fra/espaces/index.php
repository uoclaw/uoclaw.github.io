...
?>
	...
	<h2>Espaces linguistiques internationaux et systèmes juridiques correspondants </h2>
	<ul>
	  <li> Le Commonwealth 
	    <ul>
	      <li><a href="wealth/carte.php">Carte géographique de répartition des membres</a></li>
	      <li><a href="wealth/commonwealth.php">Index alphabétique des membres et systèmes juridiques correspondants</a> <br>
	        </li>
	      </ul>
	    </li>
	  <li> Organisation Internationale de la Francophonie
	    (OIF)
	    <ul>
	      <li><a href="franco/carte.php">Carte géographique de répartition des membres</a></li>
	      <li><a href="franco/francophonie.php">Index alphabétique des membres et systèmes juridiques correspondants</a></li>
	      </ul>
	    </li>
	  <li> Organisation Arabe pour l’Éducation, la Culture et les Sciences (ALECSO)
	    <ul>
	      <li><a href="alecso/carte.php">Carte géographique de répartition des membres</a></li>
	      <li><a href="alecso/alecso.php">Index alphabétique des membres et systèmes juridiques correspondants</a></li>
	      </ul>
	    </li>
	  <li>Organisation des États Ibéro-américains (OEI)
	    <ul>
	      <li><a href="oei/carte.php">Carte géographique de répartition des membres</a></li>
	      <li><a href="oei/oei.php">Index alphabétique des membres et systèmes juridiques correspondants</a></li>
	      </ul>
	    </li>
	  <li> Autres espaces linguistiques
	    <ul>
	      <li><a href="autres/turksoy.php">L’Administration Commune des Cultures et des Arts Turcs</a> (TURKSOY)</li>
	      <li><a href="autres/cplp.php">La Communauté des Pays de Langue Portugaise</a> (CPLP)</li>
	      <li><a href="autres/trois.php">Trois Espaces Linguistiques</a> (3EL)</li>
	      <li><a href="autres/unilat.php">L’Union Latine</a> (UNILAT) </li>
	      </ul>
	    </li>
