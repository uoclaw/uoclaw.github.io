...
?>
	...
	<h2>Classification des systèmes juridiques et entités politiques correspondantes
	  </h2>
	<ul>
      <li><a href="class-poli/droit-civil.php">Systèmes de droit civil et systèmes mixtes avec tradition civiliste</a></li>
      <li><a href="class-poli/common-law.php">Systèmes de common law et systèmes mixtes avec tradition de common law</a></li>
      <li><a href="class-poli/droit-musulman.php">Systèmes de droit musulman et systèmes mixtes avec tradition de droit musulman</a></li>
      <li><a href="class-poli/droit-coutumier.php">Systèmes de droit coutumier et systèmes mixtes avec tradition de droit coutumier</a></li>
      <li><a href="class-poli/sys-mixtes.php">Systèmes mixtes</a></li>
    </ul>
	<!-- InstanceEndEditable -->
</div>
