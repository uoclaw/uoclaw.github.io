...
?>
	...
	<h2>Les systèmes juridiques (classification) </h2>
	<ul>
		<li><a href="intro.php">Remarques introductives</a></li>
		<li><a href="index-syst.php">Classification des systèmes juridiques et entités politiques correspondantes</a></li>
		<li><a href="index-alpha.php">Index alphabétique  des entités politiques et systèmes juridiques correspondants</a></li>
	</ul>
	<!-- InstanceEndEditable -->
</div>
