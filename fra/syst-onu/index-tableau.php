...
?>
	...
	<h2><a href="tab-regroupement.php">Tableau statistique de répartition des États membres de l'ONU (en nombre et en %) selon la classification des systèmes juridiques </a></h2>
	<ul>
      <li><a href="tab-regroupement.php#civil">Systèmes de droit civil et systèmes mixtes avec tradition civiliste </a></li>
      <li><a href="tab-regroupement.php#common">Systèmes de common law et systèmes mixtes avec tradition de common law</a></li>
      <li><a href="tab-regroupement.php#musulman">Systèmes de droit musulman et systèmes mixtes avec tradition de droit musulman</a></li>
      <li><a href="tab-regroupement.php#coutumier">Systèmes de droit coutumier et systèmes mixtes avec tradition de droit coutumier</a></li>
      <li><a href="tab-regroupement.php#mixte">Systèmes mixtes </a></li>
	</ul>
	<!-- InstanceEndEditable -->
</div>
