...
?>
	...
	<h2>Systèmes juridiques des 192 États membres de l’Organisation des Nations Unies</h2>
	<ul>
	  <li><a href="index-alpha.php">Index alphabétique des États membres de l'ONU et systèmes juridiques correspondants </a></li>
	  <li> <a href="index-syst.php">Répartition des États membres de l'ONU selon les systèmes juridiques et leurs diverses composantes </a></li>
	  <li> <a href="tab-repartition.php">Tableau statistique de répartition des États membres de l'ONU</a> (en nombre et en %) selon les systèmes juridiques et leurs diverses composantes </li>
	  <li> <a href="index-tableau.php">Tableau statistique de répartition des États membres de l'ONU </a>(en nombre et en %) selon la classification des systèmes juridiques</li>
	  <li> <a href="repartition-onu.php">Graphique de répartition des 192 États membres de l'ONU selon les systèmes juridiques</a></li>
	  <li><a href="carte-onu.php">Carte de représentation géographique des 192 États membres de l’ONU</a></li>
	</ul>
	<!-- InstanceEndEditable -->
</div>
