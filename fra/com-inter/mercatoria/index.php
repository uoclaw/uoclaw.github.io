...
?>
	...
	<h2><em>Lex mercatoria</em> et autres sources institutionnelles (exemples significatifs)</h2>
        <ul><li><a href="gen_rec.php">Instruments généraux de recherche</a></li>
          <li><a href="inter.php">Institutions internationales </a></li>
          <li><a href="reg.php">Institutions régionales</a></li>
          <li><a href="cont_inter.php">Contrats internationaux</a></li>
          <li><a href="com_inter.php">Institutions d’arbitrage commercial international</a></li>
        </ul>
      <p>&nbsp;</p>
	<!-- InstanceEndEditable -->
</div>
