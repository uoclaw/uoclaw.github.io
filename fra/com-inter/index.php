...
?>
	...
	<h2>Commerce international et intégration juridique</h2>
	<ul>
			<li><a href="org/index.php">Organisations et conventions internationales (exemples significatifs)</a> </li>
			<li><a href="mercatoria/index.php">Lex mercatoria et autres sources institutionnelles (exemples significatifs)</a></li>
