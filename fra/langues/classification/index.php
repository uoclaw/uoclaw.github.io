...
?>
	...
	<h2> Classification des langues par système juridique</h2>
	<ul>
	  <li><a href="dcivil.php">Droit civil et systèmes mixtes avec tradition civiliste</a></li>
	  <li><a href="claw.php">Common law et systèmes mixtes avec tradition de Common law</a></li>
	  <li><a href="musulman.php">Droit musulman et systèmes mixtes avec tradition de droit musulman</a></li>
	  <li><a href="coutumier.php">Droit coutumier et systèmes mixtes avec tradition de droit coutumier</a></li>
	  <li>Systèmes mixtes </li>
	</ul>
	<!-- InstanceEndEditable -->
</div>
