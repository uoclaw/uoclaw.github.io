...
?>
	...
	<h2>Langues et systèmes juridiques</h2>
	<ul>
			<li><a href="intro.php">Remarques introductives</a></li>
			<li><a href="index-alpha.php">Index alphabétique des entités politiques, langues et systèmes juridiques correspondants</a></li>
		<li><a href="index-syst.php">Répartition des langues selon les systèmes juridiques</a></li>

			<li><a href="tab-langues-officielles.php">Tableau statistique de répartition des langues selon les systèmes juridiques</a></li>
			<li><a href="graph.php">Graphique de répartition (en nombre et % ) des langues selon les systèmes juridiques</a></li>
