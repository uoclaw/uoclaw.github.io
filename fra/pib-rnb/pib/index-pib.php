...
?>
	...
	<h2>Tableaux statistiques de répartition du PIB mondial (en US$ et en %) selon les systèmes juridiques
	  </h2>
	<ul>
	  <li><a href="tableau-repartition-pib.php"> Répartition du PIB mondial selon les systèmes juridiques et leurs diverses composantes</a></li>
	  <li><a href="tableau-dcivil-claw.php">Part du PIB mondial des systèmes de droit civil et de common law</a></li>
	  <li><a href="tableau-musulman.php">Part du PIB mondial des systèmes de droit musulman</a> </li>
	  <li><a href="tableau-coutumier.php">Part du PIB mondial des systèmes de droit coutumier</a> </li>
	  <li><a href="tableau-mixtes.php">Part du PIB mondial des systèmes de droit mixte</a></li>
	  </ul>
	<!-- InstanceEndEditable -->
</div>
