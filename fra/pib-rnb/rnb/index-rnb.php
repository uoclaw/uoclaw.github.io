...
?>
	...
	<h2>Tableaux comparatifs du RNB <em>per capita</em> moyen, selon les systèmes juridiques
	  </h2>
	<ul>
      <li><a href="tableau-comp-rnb.php">RNB <em>per capita</em> moyen selon les systèmes juridiques et leurs diverses composantes</a></li>
      <li><a href="tableau-dcivil-claw-rnb.php"> RNB <em>per capita</em> moyen des systèmes de droit civil et de common law</a></li>
      <li><a href="tableau-musulman-rnb.php">RNB <em>per capita</em> moyen des systèmes de droit musulman </a></li>
      <li><a href="tableau-coutumier-rnb.php">RNB <em>per capita</em> moyen des systèmes de droit coutumier </a></li>
      <li><a href="tableau-mixtes-rnb.php">RNB <em>per capita</em> moyen des systèmes de droit mixte</a></li>
    </ul>
	<!-- InstanceEndEditable -->
</div>
