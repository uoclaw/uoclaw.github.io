...
<div id="main-content">
	...
	<h2>Demographic  Distribution per Legal System</h2>
	<ul>
	  <li><a href="index-alpha.php">Alphabetical index of  political entities, corresponding populations and legal systems</a></li>
	  <li> <a href="index-syst.php">Legal system, political entities and  corresponding populations</a></li>
	  <li><a href="index-tableau.php">Statistical tables of distribution of the world population according to the legal systems</a></li>
	  <li><a href="graph.php">Graph of distribution of the world population (%) per legal systems</a></li>
	</ul>
	<!-- InstanceEndEditable -->
</div>
