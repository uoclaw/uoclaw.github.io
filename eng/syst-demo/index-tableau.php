...
<div id="main-content">
	...
	<!-- InstanceBeginEditable name="mainContent" -->
	      <h2>Statistical tables of distribution of the world population according to the legal systems	      </h2>
          <ul>
            <li><a href="tableau-popu.php">Distribution of the world population according to the legal systems and their various 
              components</a></li>
            <li><a href="tableau-dcivil-claw.php">Percentage of the world population (%), Civil law and Common law systems</a></li>
            <li><a href="tableau-musul.php">Percentage of the world population (%), Muslim law systems</a></li>
            <li><a href="tableau-coutumier.php">Percentage of the world population (%), Customary law systems</a></li>
            <li><a href="tableau-mixte.php">Percentage of the world population (%), Mixed systems</a></li>
          </ul>
      <!-- InstanceEndEditable -->
</div>
