...
<div id="main-content">
	...
	<h2>Communidade dos Paises de L&iacute;ngua Portuguesa - CPLP<br>
	  (The Community of Portuguese Language Countries)</h2>
	<p>Regroups 8  Member States<br>
	  Head  Office: Lisbon<br>
	  Website:  <a href="http://www.cplp.org">www.cplp.org</a></p>
	<p><strong>Legal Systems</strong>: 4 of Civil law; 3 of  Civil law/Customary law; 1 of Civil law/Muslim law/Customary law.</p>
	<p><strong>Alphabetical Index of  Member States  and corresponding legal system</strong></p>
	<table border="0" cellspacing="3" cellpadding="3">
      <tr>
        <td width="50%">Angola</td>
        <td>Civil law</td>
      </tr>
      <tr>
        <td>Brazil</td>
