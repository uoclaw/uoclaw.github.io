...
<div id="main-content">
	...
	<h2>International linguistic  spaces and corresponding legal systems</h2>
	<ul>
	  <li>The Commonwealth
	      <ul>
	        <li><a href="wealth/carte.php">Geographic map</a></li>
	        <li><a href="wealth/commonwealth.php">Alphabetical index of  members  and corresponding legal systems</a></li>
          </ul>
	    </li>
	  <li>L'Organisation Internationale de la Francophonie (OIF)
	    <ul>
	        <li><a href="franco/carte.php">Geographic map</a></li>
	        <li><a href="franco/francophonie.php">Alphabetical index of  members and corresponding legal  systems</a></li>
          </ul>
	    </li>
	  <li>The Arab League Organization for Education,  Culture and Science (ALECSO)
	      <ul>
	        <li><a href="alecso/carte.php">Geographic  map</a></li>
	        <li><a href="alecso/alecso.php">Alphabetical index of  members  and corresponding legal systems</a></li>
          </ul>
	    </li>
	  <li>The  Ibero-American States Organization for Education, Culture and Science (OEI)
	      <ul>
	        <li><a href="oei/carte.php">Geographic map</a></li>
	        <li><a href="oei/oei.php">Alphabetical index of  members  and corresponding legal systems</a></li>
          </ul>
	    </li>
	  <li>Other Linguistic Spaces
	      <ul>
	        <li><a href="autres/turksoy.php">The Common Administration of  Turkish Arts and Culture</a> (TURKSOY)</li>
	        <li><a href="autres/cplp.php">The Community of Portuguese  Language Countries</a> (CPLP)</li>
	        <li><a href="autres/trois.php">The Three Linguistic Spaces</a> (3EL)</li>
	        <li><a href="autres/unilat.php">The Latin Union</a> (UNILAT)</li>
          </ul>
	    </li>
