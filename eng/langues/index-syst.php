...
<div id="main-content">
	...
	<!-- InstanceBeginEditable name="mainContent" -->
	      <h2>Distribution of languages by legal systems	      </h2>    
	      <ul>
            <li><a href="classification/dcivil.php">Civil law systems and mixed systems with Civil law</a> </li>
            <li><a href="classification/claw.php">Common law systems and mixed systems with Common law</a></li>
            <li><a href="classification/musulman.php">Muslim law systems and mixed systems with Muslim law</a></li>
            <li><a href="classification/coutumier.php">Customary law systems and mixed systems with Customary law</a> </li>
            <li><a href="classification/mixtes.php">Mixed legal systems</a></li>
          </ul>
    <!-- InstanceEndEditable -->
</div>
