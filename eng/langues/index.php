...
<div id="main-content">
	...
	<h2>Languages and Legal Systems </h2>
	<ul><li><a href="intro.php">Introductory Remarks</a></li>
		  <li><a href="index-alpha.php">Alphabetical index of political entities, languages and corresponding legal systems </a></li>
	    <li><a href="index-syst.php">Distribution of languages by legal systems</a></li>
		  <li><a href="tab-langues-officielles.php">Statistical table on distribution of languages per political entities' legal systems</a></li>
		  <li><a href="graph.php">Graph of distribution of languages per legal systems</a></li>
