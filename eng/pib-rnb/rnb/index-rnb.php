...
<div id="main-content">
	...
	<h2>Comparative tables of the average GNI <em>per capita</em>, according to the legal systems	  </h2>
	<ul>
      <li><a href="tableau-comp-rnb.php">Average GNI <em>per capita</em>, according to the legal systems and their various components</a></li>
      <li><a href="tableau-dcivil-claw-rnb.php">Average GNI <em>per capita</em>, Civil law and Common law systems</a></li>
      <li><a href="tableau-musulman-rnb.php">Average GNI <em>per capita,</em> Muslim law systems</a></li>
      <li><a href="tableau-coutumier-rnb.php">Average GNI <em>per capita</em>, Customary law systems</a></li>
      <li><a href="tableau-mixtes-rnb.php">Average GNI <em>per capita</em>, Mixed systems</a></li>
    </ul>
	<!-- InstanceEndEditable -->
</div>
