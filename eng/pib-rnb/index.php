...
<div id="main-content">
	...
	<h2>Distribution of the World Gross Domestic Product (GDP) and of the Gross National Income (GNI) <em>per capita</em></h2>
	<ul>
	  <li><a href="index-alpha.php">Alphabetical index of the political entities and corresponding legal systems <br>
	    GDP and GNI <em>per capita</em></a></li>
	  <li><a href="index-syst.php">Tables of distribution of the world GDP and GNI per capita (in US$) per legal systems and<br>
	    their various components</a></li>
	  <li><a href="pib/index-pib.php">Statistical tables of distribution of the world GDP (in % and US$) according to the legal <br>
	    systems</a></li>
	  <li><a href="graph_pib.php">Graph of distribution of the world GDP (in %) per legal systems</a></li>
	  <li><a href="rnb/index-rnb.php">Comparative tables of the average GNI <em>per capita</em>, according to the legal systems</a></li>
	  <li><a href="graph_rnb.php">Comparative Graph of the average GNI <em>per capita </em>according to the legal systems</a> </li>
	  </ul>
	<!-- InstanceEndEditable -->
</div>
