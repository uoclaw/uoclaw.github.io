...
<div id="main-content">
	...
	<h2>Statistical tables of distribution of the world GDP (in % and US&nbsp;$) according to the legal 
	  systems	  </h2>
	<ul>
      <li><a href="tableau-repartition-pib.php">Distribution of the world GDP according to the legal systems and their various components</a></li>
      <li><a href="tableau-dcivil-claw.php">Share of the world GDP (in % and US&nbsp;$), Civil law and Common law systems</a></li>
      <li><a href="tableau-musulman.php">Share of the world GDP (in % and US&nbsp;$), Muslim law systems</a></li>
      <li><a href="tableau-coutumier.php">Share of the world GDP (in % and US&nbsp;$), Customary law systems</a></li>
      <li><a href="tableau-mixtes.php">Share of the world GDP (in % and US&nbsp;$), Mixed systems</a></li>
    </ul>
	<!-- InstanceEndEditable -->
</div>
