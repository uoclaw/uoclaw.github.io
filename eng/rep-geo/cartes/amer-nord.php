...
<div id="main-content">
	...
	<map name="north-amer">
      ...
      <area shape=rect alt="UNITED_STATES_OF_AMERICA" href="../../sys-juri/index-alpha.php#UNITED_STATES_OF_AMERICA" coords="200,320,357,335">
    </map>

	<h2>NORTH AMERICA </h2>
	<p><img usemap="#north-amer" src="../../../images/eng/rep-geo/amer-nord.jpg" width="550" height="520"></p>
	<!-- InstanceEndEditable -->
</div>
