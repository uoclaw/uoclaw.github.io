...
<div id="main-content">
    ...
    <h2>International Trade and Legal Integration</h2>
    <ul>
			<li><a href="org/index.php">International Organisations and Conventions (significant examples)</a></li>
			<li><a href="mercatoria/index.php"><em>Lex mercatoria</em> and other institutional sources (significant examples)</a></li>
