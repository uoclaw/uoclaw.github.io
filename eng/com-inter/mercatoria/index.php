...
<div id="main-content">
	...
	<h2><em>Lex mercatoria</em> and other institutional sources (significant examples)</h2>
	<ul>
	  <li><a href="gen_rec.php">General Research Tools</a></li>
	  <li><a href="inter.php"> International institutions</a></li>
	  <li><a href="reg.php">Regional Institutions</a></li>
	  <li><a href="cont_inter.php">International Contracts </a></li>
	  <li><a href="com_inter.php">International Commercial Arbitration</a></li>
	  </ul>
	<!-- InstanceEndEditable -->
</div>
