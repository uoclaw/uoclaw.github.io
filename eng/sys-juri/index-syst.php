...
<div id="main-content">
	...
	<!-- InstanceBeginEditable name="mainContent" -->
	    <h2>Classification of legal  systems and corresponding political entities 
	    </h2>
	    <ul>
	      <li><a href="class-poli/droit-civil.php">Civil law systems and mixed systems with Civil law</a></li>
	      <li><a href="class-poli/common-law.php">Common law systems and mixed systems with Common law</a></li>
	      <li><a href="class-poli/droit-coutumier.php">Customary law systems and mixed systems with Customary law</a></li>
	      <li><a href="class-poli/droit-musulman.php">Muslim law systems and mixed systems with Muslim law</a></li>
	      <li><a href="class-poli/sys-mixtes.php">Mixed Systems</a></li>
      </ul>
      <!-- InstanceEndEditable -->
</div>
