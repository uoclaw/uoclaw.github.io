...
?>
	...
	<h2><a href="tab-regroupement.php">Tabla de distribución de los Estados miembros de la ONU (en  n&uacute;mero y en % ) según la clasificación  de los sistemas jurídicos</a></h2>
	<ul>
	  <li><a href="tab-regroupement.php#civil">Sistemas de derecho civil y sistemas mixtos con tradición civilista</a></li>
	  <li><a href="tab-regroupement.php#common">Sistemas de common law y  sistemas mixtos con tradición de common law</a></li>
	  <li><a href="tab-regroupement.php#musulman">Sistemas de derecho musulmán  y sistemas mixtos con  tradición de  derecho<br>
	    musulmán</a></li>
	  <li><a href="tab-regroupement.php#coutumier">Sistemas de derecho  consuetudinario y sistemas mixtos de derecho<br>
	    consuetudinario</a></li>
	  <li><a href="tab-regroupement.php#mixte">Sistemas mixtos </a></li>
	</ul>
	<!-- InstanceEndEditable -->
</div>
