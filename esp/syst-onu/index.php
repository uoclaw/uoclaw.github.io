...
?>
	...
	<h2>Sistemas  jurídicos de los Estados miembros de la Organización de las Naciones Unidas (ONU)  </h2>
	<ul>
	  <li><a href="index-alpha.php">Índice alfabético de los Estados miembros de la ONU y  sistemas jurídicos correspondientes</a></li>
	  <li><a href="index-syst.php">Distribución de los Estados miembros de la ONU por  sistemas jurídicos y sus varios componentes </a></li>
	  <li><a href="tab-repartition.php">Tabla de distribución de los Estados miembros de la  ONU  (en n&uacute;mero y %) según los sistemas jurídicos y sus varios  componentes</a></li>
	  <li><a href="index-tableau.php">Tabla de distribución de los Estados miembros de la ONU (en  n&uacute;mero y en % ) según la clasificación  de los sistemas jurídicos</a></li>
	  <li><a href="repartition-onu.php">Gráfico de distribución de los Estados miembros de la ONU  por sistemas jurídicos</a></li>
	  <li><a href="carte-onu.php">Representación geográfica de los 192 Estados miembros de la ONU</a></li>
	  </ul>
	<!-- InstanceEndEditable -->
</div>
