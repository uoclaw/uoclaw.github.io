...
?>
	...
	<h2>Sistemas jurídicos y distribución demográfica</h2>
	<ul>
	  <li><a href="index-alpha.php">Índice alfabético de las entidades políticas, poblaciones y sistemas jurídicos                                 correspondientes</a></li>
	  <li><a href="index-syst.php">Sistemas jurídicos, entidades políticas y poblaciones correspondientes</a></li>
	  <li><a href="index-tableau.php"> Tablas estadísticas de distribución de la población mundial por sistemas jurídicos</a></li>
	  <li><a href="graph.php"> Gráfico de distribución de la población mundial  por sistemas jurídicos</a></li>
	  </ul>
	<!-- InstanceEndEditable -->
</div>
