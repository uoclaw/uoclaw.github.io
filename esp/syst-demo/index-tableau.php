...
?>
	...
	<h2>Tablas estadísticas de distribución de la población mundial por sistemas jurídicos
	  </h2>
	<ul>
      <li><a href="tableau-popu.php">Distribución de la población mundial según los sistemas jurídicos y sus varios componentes  jurídicos</a></li>
      <li><a href="tableau-dcivil-claw.php">Porcentaje de la población mundial correspondiente a los sistemas de derecho civil y de  common law</a></li>
      <li><a href="tableau-musul.php">Porcentaje de la población mundial  correspondiente a los sistemas de derecho musulmán</a></li>
      <li><a href="tableau-coutumier.php">Porcentaje de la población mundial  correspondiente a los sistemas de derecho consuetudinario</a></li>
      <li><a href="tableau-mixte.php">Porcentaje de la población mundial correspondiente a los sistemas mixtos</a></li>
    </ul>
	<!-- InstanceEndEditable -->
</div>
