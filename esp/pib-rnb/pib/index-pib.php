...
?>
	...
	<h2>Tablas estadísticas de  distribución del PIB mundial (en US$ y en %) por sistemas jurídicos  </h2>
	<ul>
      <li><a href="tableau-repartition-pib.php">Distribución de PIB mundial según los sistemas jurídicos y sus varios componentes</a></li>
	  <li><a href="tableau-dcivil-claw.php">Porción del PIB mundial correspondiente a los sistemas de derecho  civil y de common law</a></li>
	  <li><a href="tableau-musulman.php">Porción del PIB mundial correspondiente a los sistemas de derecho musulmán</a></li>
	  <li><a href="tableau-coutumier.php">Porción del PIB mundial correspondiente a los sistemas de derecho consuetudinario</a></li>
	  <li><a href="tableau-mixtes.php">Porción del PIB mundial correspondiente a los sistemas mixtos</a></li>
	  </ul>
	<!-- InstanceEndEditable -->
</div>
