...
?>
	...
	<h2>Distribución del Producto  Interno Bruto (PIB) mundial y del Ingreso Nacional Bruto (PNB) <em>per capita</em>, por sistemas jurídicos</h2>
	<ul>
	  <li><a href="index-alpha.php">Índice alfabético de las entidades  políticas, sistemas jurídicos,  PIB, e PNB <em>per capita</em> correspondientes</a></li>
	  <li><a href="index-syst.php">Distribución del PIB mundial y del PNB <em>per capita </em>según los sistemas jurídicos y sus varios componentes</a></li>
	  <li><a href="pib/index-pib.php">Tablas estadísticas de  distribución del PIB mundial (en US$ y en %) por sistemas jurídicos  </a></li>
	  <li><a href="graph_pib.php">Gr&aacute;fico comparativo (en %) del PIB por sistemas jurídicos con relación  al PIB mundial</a></li>
	  <li><a href="rnb/index-rnb.php">Tablas comparativas del PNB <em>per capita</em> promedio (en %) por sistemas  jurídicos</a></li>
	  <li><a href="graph_rnb.php">Gráfico comparativo del PNB <em>per capita</em> promedio (en US$) por  sistemas 
	    jurídicos</a></li>
	  </ul>
	<!-- InstanceEndEditable -->
</div>
