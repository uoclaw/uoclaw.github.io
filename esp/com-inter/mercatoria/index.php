...
?>
	...
	<h2> <em>Lex mercatoria</em> y otras fuentes  institucionales (ejemplos significativos)</h2>
	<ul>
	  <li><a href="gen_rec.php">Instrumentos generales de  investigación</a></li>
	  <li><a href="inter.php">Instituciones internacionales</a></li>
	  <li><a href="reg.php">Instituciones regionales</a></li>
	  <li><a href="cont_inter.php">Contratos internacionales</a></li>
	  <li><a href="com_inter.php">Instituciones de arbitraje  comercial internacional</a></li>
