...
?>
	...
	<h2>Comercio internacional y integración  jurídica</h2>
	<ul>
	  <li><a href="org/index.php">Organizaciones y Convenciones  internacionales (ejemplos significativos)</a></li>
	  <li>	  <a href="mercatoria/index.php"><em>Lex mercatoria</em> y otras fuentes  institucionales (ejemplos significativos)</a></li>
