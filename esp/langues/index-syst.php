...
?>
	...
	<h2>Distribución de los idiomas por sistemas  jurídicos
	  </h2>
	<ul>
      <li><a href="classification/dcivil.php">Sistemas de derecho civil  y sistemas mixtos con derecho civil</a></li>
      <li><a href="classification/claw.php">Sistemas de common law y sistemas mixtos con common law</a></li>
      <li><a href="classification/musulman.php">Sistemas de derecho musulmán y sistemas mixtos con derecho musulmán </a></li>
      <li><a href="classification/coutumier.php">Sistema de derecho consuetudinario y sistemas mixtos con derecho consuetudinario</a></li>
      <li><a href="classification/mixtes.php">Sistemas mixtos</a></li>
    </ul>
	<!-- InstanceEndEditable -->
</div>
