...
?>
	...
	<h2>Idiomas y sistemas jurídicos</h2>
	<ul>
	  <li><a href="intro.php">Nota introductiva</a></li>
	  <li><a href="index-alpha.php">Índice alfabético de las entidades políticas e idiomas correspondientes </a></li>
	  <li><a href="index-syst.php">Distribución de los idiomas por sistemas  jurídicos</a></li>
	  <li><a href="tab-langues-officielles.php">Tabla estadística de distribución de los idiomas por sistemas jurídicos</a></li>
	  <li><a href="graph.php">Gráfico de distribución (en  número y %) de los idiomas por sistemas jurídicos</a></li>
