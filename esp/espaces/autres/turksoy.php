...
?>
	...
	<h2>La administración común de las culturas y  artes turcos (TURKSOY)</h2>
	<p>Constituida  por Turquia, las cinco Repúblicas turco parlantes de la Ex-URSS, y por
	  8 regiones turco parlantes de varias partes  del mundo*<br>
	  Sede:  Ankara<br>
	  Sitio  web&nbsp;: <a href="http://www.turksoy.org">www.turksoy.org</a></p>
	<p><strong>Sistemas jurídicos </strong>de Turqu<strong>í</strong>a y de las 5  Republicas: derecho civil</p>
	<p><strong>Índice alfabético de los miembros y  sistemas jurídicos correspondientes</strong></p>
	<table width="100%" border="0" cellspacing="3" cellpadding="3">
      <tr>
        <td width="40%">Azerbaiyán</td>
        <td>Derecho  civil</td>
      </tr>
      <tr>
        <td>Kazajstán</td>
	...
	<p>*  Altai, Baskurdistan, Saha (Yakut), Tataristan, Tiva (Regiones de la Federación  de Rusia),<br>
	  Hakas (Region de Moldova) y Gagavuz  Yeri (Región del Uzbekistán) son de tradición<br>
	  civilista.  <br>
	  - KKTC  (Región Norte de Chipre) es de derecho mixto: common law / derecho civil</p>
