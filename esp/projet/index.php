...
?>
	...
	<ul>
	  <li><a href="http://www.droitcivil.uottawa.ca/fr/nouvelles/nouvelles-de-la-faculte/pour-tout-savoir-sur-les-systemes-juridiques-dans-le-monde-juriglobe/id-menu-67.html">Conferencia: la presentación de trabajos JuriGlobe</a></li>
	  <li><a href="http://www.droitcivil.uottawa.ca/index.php?option=com_content&task=view&id=1490&lang=fr">Symposio Jurídico</a></li>
	  <li>Sistemas Constitucionales del Mundo</li>
	  <li>Los sistemas de procedimiento penal en el mundo</li>
	  </ul>
	<!-- InstanceEndEditable -->
</div>
