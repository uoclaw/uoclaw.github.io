...
?>
	...
	<h2>Sistemas  jurídicos (clasificación) </h2>
	<ul>
	  <li><a href="intro.php">Nota introductiva</a></li>
	  <li><a href="index-syst.php">Clasificación por sistemas jurídicos y entidades políticas correspondientes</a></li>
	  <li><a href="index-alpha.php">Índice alfabético de las entidades políticas y sistemas jurídicos correspondientes</a></li>
	  </ul>
