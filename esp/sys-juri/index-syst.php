...
?>
	...
	<h2>Clasificación por sistemas jurídicos y entidades políticas correspondientes</h2>
	<ul>
	  <li><a href="class-poli/droit-civil.php">Sistemas de derecho civil y sistemas mixtos con derecho civil</a> </li>
	  <li><a href="class-poli/common-law.php">Sistemas de common law y sistemas mixtos con  common law</a></li>
	  <li><a href="class-poli/droit-musulman.php">Sistemas de derecho musulmán y sistemas mixtos con derecho musulmán</a></li>
	  <li><a href="class-poli/droit-coutumier.php">Sistemas de derecho consuetudinario y sistemas mixtos con derecho consuetudinario</a></li>
	  <li><a href="class-poli/sys-mixtes.php">Sistemas mixtos</a></li>
	  </ul>
	<p>&nbsp;</p>
	<!-- InstanceEndEditable -->
</div>
