...
?>
	...
	<h2>Сообщество стран португальского  языка (CPLP)</h2>
	<p>Сообщество стран португальского  языка объединяет 8 стран–членов.<br>
	  Главный офис находится в Лиссабоне.<br>
	  Официальный сайт: <a href="http://www.cplp.org/">www.cplp.org</a> .</p>
	<p align="justify"><strong>Правовые системы</strong>: 4 системы континентального  права; 3 смешанные системы континентального и обычного права; 1 смешанная  система континентального, мусульманского и обычного права. </p>
	<p><strong>Алфавитный указатель стран–членов</strong> <strong>и соответствующих правовых систем</strong></p>
	<table border="0" cellspacing="3" cellpadding="3">
      <tr>
        <td valign="top"><p>Ангола</p></td>
        <td valign="top"><p>Континентальное право</p></td>
      </tr>
      <tr>
        <td valign="top"><p>Бразилия</p></td>
        <td valign="top"><p>Континентальное право</p></td>
      </tr>
      <tr>
        <td valign="top"><p>Восточный Тимор</p></td>
        <td valign="top"><p>Континентальное право/мусульманское право/обычное    право</p></td>
      </tr>
      <tr>
        <td valign="top"><p>Гвинея-Бисау</p></td>
        <td valign="top"><p>Континентальное право/обычное право</p></td>
      </tr>
      <tr>
        <td valign="top"><p>Кабо-Верде</p></td>
        <td valign="top"><p>Континентальное право</p></td>
      </tr>
      <tr>
        <td valign="top"><p>Мозамбик</p></td>
        <td valign="top"><p>Обычное право/континентальное право</p></td>
      </tr>
      <tr>
        <td valign="top"><p>Португалия</p></td>
        <td valign="top"><p>Континентальное право</p></td>
      </tr>
      <tr>
        <td valign="top"><p>Сан-Томе и Принсипи</p></td>
        <td valign="top"><p>Континентальное право/обычное право</p></td>
      </tr>
    </table>
	<p>  </p>
