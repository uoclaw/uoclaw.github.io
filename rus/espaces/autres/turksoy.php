...
?>
	...
	<h2>Международная организация по  совместному развитию тюркской культуры и искусства (TURKSOY)</h2>
	<p>Международная  организация по совместному развитию тюркской культуры и искусства объединяет  Турцию, 5 стран, в которых используется турецкий язык, а также 8 турецко-говорящих  регионов различных частей мира.* </p>
	<p><strong>Правовые системы</strong> Турции и 5 других стран: континентальные системы. </p>
	...
	<table border="0" cellspacing="3" cellpadding="3" width="100%">
      ...
      <tr>
        <td valign="top"><p>Кыргызстан</p></td>
        <td valign="top"><p>Континентальное право</p></td>
      </tr>
      <tr>
        <td valign="top"><p>Туркменистан</p></td>
        <td valign="top"><p>Континентальное право</p></td>
      </tr>
      <tr>
        <td valign="top"><p>Турция</p></td>
        <td valign="top"><p>Континентальное право</p></td>
      </tr>
      <tr>
	...
	<p>* Регионы Российской Федерации:  Алтай, Башкортостан, Саха (Якутия), Татарстан, Тыва; Хакас (регион Молдовы); Гагауз-Ери  (регион в Узбекистане). Данные регионы относятся к правовой традиции континентального  права.  </p>
	В ККТС (Северный регион  Кипра) смешанная система права: общее право и континентальное право.
	<p>  </p>
	<!-- InstanceEndEditable -->
</div>
