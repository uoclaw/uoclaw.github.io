...
?>
	...
	<h2>Международные лингвистические объединения<br>
	  и соответствующие правовые системы</h2>
	<ul>
	  <li>Содружество наций
	      <ul>
	        <li><a href="wealth/carte.php">Географическая карта распределения членов </a></li>
	        <li><a href="wealth/commonwealth.php">Алфавитный указатель членов и соответствующих правовых систем</a></li>
          </ul>
	    </li>
	  <li>Международная организация Франкофонии (OIF)
	    <ul>
	        <li><a href="franco/carte.php">Географическая карта распределения членов </a></li>
	        <li><a href="franco/francophonie.php">Алфавитный указатель членов и соответствующих правовых систем</a></li>
          </ul>
	    </li>
	  <li>Организация по вопросам образования, культуры и науки Лиги арабских государств  (ALECSO)
	      <ul>
	        <li><a href="alecso/carte.php">Географическая карта распределения членов </a></li>
	        <li><a href="alecso/alecso.php">Алфавитный указатель членов и соответствующих правовых систем</a></li>
          </ul>
	    </li>
	  <li>Организация по вопросам образования, культуры и науки иберо-американских государств  (OEI)
	      <ul>
	        <li><a href="oei/carte.php">Географическая карта распределения членов </a></li>
	        <li><a href="oei/oei.php">Алфавитный указатель членов и соответствующих правовых систем</a></li>
          </ul>
	    </li>
	  <li>Другие лингвистические образования 
	      <ul>
	        <li><a href="autres/turksoy.php">Международная организация по совместному развитию тюркской культуры и искусства </a> (TURKSOY)</li>
	        <li><a href="autres/cplp.php">Сообщество стран португальского языка</a> (CPLP)</li>
	        <li><a href="autres/trois.php">Три лингвистических пространства </a> (3EL)</li>
	        <li><a href="autres/unilat.php">Латинский союз</a> (UNILAT)</li>
          </ul>
	    </li>
	  <li><a href="biblio.php">Библиография</a></li>
	</ul>
	<!-- InstanceEndEditable -->
</div>
