...
?>
	...
	<h2>ТАБЛИЦА РАСПРЕДЕЛЕНИЯ НАСЕЛЕНИЯ В СМЕШАННЫХ СИСТЕМАХ (в процентах)</h2>
	<table cellspacing="3" cellpadding="3">
      ...
      <tr>
        <td width="318"><p><strong>ОБЩИЙ ПРОЦЕНТ НАСЕЛЕНИЯ В    СМЕШАННЫХ ПРАВОВЫХ СИСТЕМАХ</strong></p></td>
