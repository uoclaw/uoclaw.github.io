...
?>
	...
	<h2>Статистические таблицы распределения мирового населения по правовым системам
	  </h2>
	<ul>
	  <li><a href="tableau-popu.php">Распределение  мирового населения по правовым системам</a></li>
	  <li><a href="tableau-dcivil-claw.php">Процент мирового населения в системах континентального и общего права</a></li>
	  <li><a href="tableau-musul.php">Процент мирового населения в системах мусульманского права</a></li>
	  <li><a href="tableau-coutumier.php">Процент мирового населения в системах обычного права</a></li>
	  <li><a href="tableau-mixte.php">Процент мирового населения в смешанных системах права</a></li>
	  </ul>
	<!-- InstanceEndEditable -->
</div>
