...
?>
	...
	<h2><strong>Демографическое  распределение по правовым системам</strong></h2>
	<ul>
	  <li><a href="index-alpha.php">Алфавитный указатель политических образований, соответствующих правовых систем и численности населения</a></li>
	  <li> <a href="index-syst.php">Правовые системы, политические образования и население</a></li>
	  <li><a href="index-tableau.php">Статистические таблицы распределения мирового населения по правовым системам</a></li>
	  <li><a href="graph.php">График распределения мирового населения по правовым системам (в процентах)</a></li>
	</ul>
	<!-- InstanceEndEditable -->
</div>
