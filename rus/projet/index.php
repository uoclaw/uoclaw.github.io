...
<!-- InstanceBeginEditable name="pageLinks" -->
	<ul id="page-links">
		...
		<li><a id="ch-lang-url" href="/index.php" rel="alternate" lang="fr" hreflang="fr">Français</a></li>
		<li><a id="section-home" href="/rus/index.php">Return to the home page</a></li>
	</ul>
<!-- InstanceEndEditable -->
	<!-- /#page-links -->
...
?>
	...
	<ul>
	  <li><a href="http://www.droitcivil.uottawa.ca/fr/nouvelles/nouvelles-de-la-faculte/pour-tout-savoir-sur-les-systemes-juridiques-dans-le-monde-juriglobe/id-menu-67.html">Исследовательский семинар: презентация результатов работы “JuriGlobe” </a></li>
	  <li><a href="http://www.droitcivil.uottawa.ca/index.php?option=com_content&task=view&id=1490&lang=fr">Симпозиум по вопросам взаимодействия между мусульманским правом и другими правовыми системами</a></li>
	  <li>Системы конституций в мире</li>
	  <li>Системы уголовного судопроизводства в мире</li>
	  </ul>
	<!-- InstanceEndEditable -->
</div>
