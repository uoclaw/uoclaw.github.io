...
?>
	...
	<h2>Правовые системы стран–членов ООН</h2>
	<ul>
	  <li><a href="index-alpha.php">Алфавитный указатель 192 стран–членов  ООН и соответствующих правовых систем</a></li>
	  <li><a href="index-syst.php"><u>Распределение       стран–членов ООН по правовым системам </u></a></li>
	  <li><a href="tab-repartition.php"><u>Статистическая       таблица распределения стран–членов ООН по правовым системам (по количеству       и в процентах)</u></a></li>
	  <li><a href="index-tableau.php">Статистическая таблица распределения стран–членов ООН по правовым системам (по количеству и в процентах)</a></li>
	  <li><a href="repartition-onu.php">График распределения стран–членов ООН по правовым системам</a></li>
	  <li><a href="carte-onu.php">Географическое распределение 192 стран – членов ООН</a></li>
	  </ul>
	<!-- InstanceEndEditable -->
</div>
