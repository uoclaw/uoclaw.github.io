...
?>
	...
	<h2><a href="tab-regroupement.php">Статистическая таблица распределения стран–членов ООН по правовым системам (по количеству и в процентах)</a>
	  </h2>
	<ul>
      <li><a href="tab-regroupement.php#civil">Системы континентального права и смешанные с континентальным правом системы</a></li>
      <li><a href="tab-regroupement.php#common">Системы общего права и смешанные с общим правом системы</a></li>
      <li><a href="tab-regroupement.php#coutumier">Системы обычного права и смешанные с обычным правом системы</a></li>
      <li><a href="tab-regroupement.php#musulman">Системы мусульманского права и смешанные с мусульманским правом системы</a></li>
      <li><a href="tab-regroupement.php#mixte">Смешанные системы права  </a></li>
	</ul>
	<!-- InstanceEndEditable -->
</div>
