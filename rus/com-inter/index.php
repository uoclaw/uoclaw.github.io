...
?>
    ...
    <h2> Международная торговая и правовая интеграция</h2>
    <ul>
			<li><a href="org/index.php">Международные организации и конвенции (основные примеры)</a></li>
			<li><a href="mercatoria/index.php"><em>Lex mercatoria</em> и неофициальные источники (основные примеры)</a></li>
