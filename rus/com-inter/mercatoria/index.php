...
?>
	...
	<h2><em>Lex mercatoria</em> и неофициальные источники <br>
	  (основные примеры)</h2>
	<ul>
	  <li><a href="gen_rec.php">Основные инструменты поиска</a></li>
	  <li><a href="inter.php">Международные организации</a></li>
	  <li><a href="reg.php">Региональные организации</a></li>
	  <li><a href="cont_inter.php">Международные договоры</a></li>
	  <li><a href="com_inter.php">Международный коммерческий арбитраж</a></li>
	  </ul>
	<!-- InstanceEndEditable -->
</div>
