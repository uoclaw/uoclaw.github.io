...
?>
	...
	<h2>Дискламация</h2>
	<h3>ПОЛОЖЕНИЕ ОБ  ОТКАЗЕ ОТ ОТВЕТСТВЕННОСТИ </h3>
	<p id="p-indent">Информация, представленная на данном сайте, собиралась тщательно и  внимательно. Материалы сайта будут периодически обновляться. Учитывая, что в  отдельных случаях информация является предметом толкования, материалы сайта не  должны рассматриваться в качестве юридического или профессионального совета.</p>
	<p id="p-indent" align="justify">Оттавский университет, Факультет права и отделение  континентального права, а также группа создателей и разработчиков данного сайта  не несут ответственности за его содержание. </p>
	<h3>АВТОРСКИЕ ПРАВА </h3>
	<p id="p-indent" align="justify">Материалы, представленные на данном сайте, защищены авторским правом. Для их  использования в личных, образовательных или некоммерческих информационных целях  не требуется получения разрешения, если отделение континентального права  Факультета права Оттавского университета обозначается в качестве источника  информации, а также указывается соответствующий адрес унифицированного  указателя информационного ресурса (URL address).</p>
	<p id="p-indent" align="justify">Любое лицо, планирующее использовать данный сайт для любой другой цели,  должен получить предварительное письменное согласие отделения континентального  права Факультета права Оттавского университета:  <a href="mailto:dcivil@uottawa.ca">dcivil@uottawa.ca</a> .</p>
	<!-- InstanceEndEditable -->
</div>
