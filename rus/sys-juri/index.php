...
?>
	...
	<h2>Правовые системы </h2>
	<ul>
	  <li><a href="intro.php">Вступительные замечания</a></li>
	  <li><a href="index-syst.php">Классификация правовых систем и соответствующих политических образований</a></li>
	  <li><a href="index-alpha.php">Алфавитный указатель политических образований и соответствующих правовых систем </a></li>
	  </ul>
	<!-- InstanceEndEditable -->
</div>
