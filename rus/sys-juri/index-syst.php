...
?>
	...
	<h2>Классификация правовых систем и соответствующих политических образований
	  </h2>
	<ul>
      <li><a href="class-poli/droit-civil.php">Системы континентального права и смешанные с континентальным правом системы </a></li>
      <li><a href="class-poli/common-law.php">Системы общего права и смешанные        с общим правом системы </a></li>
      <li><a href="class-poli/droit-coutumier.php">Системы обычного права и смешанные с обычным правом системы </a></li>
      <li><a href="class-poli/droit-musulman.php">Системы мусульманского права и смешанные с мусульманским правом системы </a></li>
      <li><a href="class-poli/sys-mixtes.php">Смешанные системы </a></li>
    </ul>
	<!-- InstanceEndEditable -->
</div>
