...
?>
	...
	<h2>ДОЛЯ МИРОВОГО ВВП В ПРАВОВЫХ СИСТЕМАХ ОБЫЧНОГО ПРАВА (в долл. США и в процентах)</h2>
	<table cellspacing="3" cellpadding="3">
      <tr>
        <td><p align="center"><strong>ПРАВОВЫЕ СИСТЕМЫ</strong></p></td>
        <td><p align="center"><strong>Долл. США</strong><br>
                <strong> (млрд.)</strong></p></td>
        <td><p align="center"><strong>ПРОЦЕНТ </strong><br>
                <strong>МИРОВОГО ВВП</strong></p></td>
      </tr>
      <tr>
        <td width="288"><p>СМЕШАННЫЕ СИСТЕМЫ    КОНТИНЕНТАЛЬНОГО И ОБЫЧНОГО ПРАВА </p></td>
      ...
      <tr>
        <td width="288"><p>МОНОСИСТЕМЫ ОБЫЧНОГО ПРАВА<strong></strong></p></td>
        <td width="163"><p align="right"> 9.6 </p></td>
        <td width="186"><p align="right"><strong> 0.02 % </strong></p></td>
      </tr>
      <tr>
        <td width="288"><p><strong>ВВП ПРАВОВЫХ СИСТЕМ ОБЫЧНОГО ПРАВА</strong></p></td>
        <td width="163"><p align="right"><strong> 10 719.7 </strong></p></td>
        <td width="186"><p align="right"><strong> 22.03 % </strong></p></td>
      </tr>
    </table>
	<p>&nbsp; </p>
	<!-- InstanceEndEditable -->
