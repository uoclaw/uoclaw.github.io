...
?>
	...
	<h2>Сравнительные таблицы распределения среднего валового  национального дохода на душу населения по правовым системам </h2>
	<ul type="disc">
      <li><a href="tableau-comp-rnb.php">Средний ВНД на душу населения в правовых       системах </a></li>
	  <li><a href="tableau-dcivil-claw-rnb.php">Средний ВНД на душу населения в правовых       системах континентального права и общего права</a></li>
	  <li><a href="tableau-musulman-rnb.php">Средний ВНД на душу населения в правовых       системах мусульманского права</a></li>
	  <li><a href="tableau-coutumier-rnb.php">Средний ВНД на душу населения в правовых       системах обычного права </a></li>
	  <li><a href="tableau-mixtes-rnb.php">Средний ВНД на душу населения в смешанных правовых       системах </a></li>
	  </ul>
	<p>&nbsp;</p>
	<!-- InstanceEndEditable -->
</div>
