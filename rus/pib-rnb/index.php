...
?>
	...
	<h2>Распределение мирового внутреннего валового продукта (ВВП) и валового национального дохода (ВНД) на душу населения</h2>
	<ul>
	  <li><a href="index-alpha.php">Алфавитный указатель политических образований и соответствующих правовых систем, ВВП и ВНД на душу населения</a></li>
	  <li><a href="index-syst.php">Таблицы  распределения мирового ВВП и ВНД на душу населения по правовым системам</a></li>
	  <li><a href="pib/index-pib.php">Статистические таблицы распределения мирового ВВП по правовым системам</a></li>
	  <li><a href="graph_pib.php">График распределения мирового ВВП по правовым системам</a></li>
	  <li><a href="rnb/index-rnb.php">Сравнительные таблицы распределения среднего ВНД на душу населения по правовым системам</a></li>
	  <li><a href="graph_rnb.php">Сравнительный график распределения среднего ВНД на душу населения по правовым системам</a></li>
	  </ul>
	<!-- InstanceEndEditable -->
</div>
