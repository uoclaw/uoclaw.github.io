...
?>
	...
	<h2>Языки и правовые системы</h2>
	<ul><li><a href="intro.php">Вступительные  замечания</a></li>
		  <li><a href="index-alpha.php">Алфавитный указатель политических образований, соответствующих правовых систем и официальных языков </a></li>
	    <li><a href="index-syst.php">Распределение  языков по правовым системам</a></li>
		  <li><a href="tab-langues-officielles.php">Статистическая таблица распределения языков по правовым системам</a></li>
		  <li><a href="graph.php">График  распределения языков по правовым системам</a></li>
