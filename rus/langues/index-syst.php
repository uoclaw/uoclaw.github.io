...
?>
	...
	<h2>Распределение  языков по правовым системам
	  </h2>
	<ul>
      <li><a href="classification/dcivil.php">Системы континентального права и смешанные с континентальным правом системы</a> </li>
      <li><a href="classification/claw.php">Системы общего права и смешанные с общим правом системы</a></li>
      <li><a href="classification/musulman.php">Системы мусульманского права и смешанные с мусульманским правом системы</a></li>
      <li><a href="classification/coutumier.php">Системы обычного права и смешанные с обычным правом системы</a> </li>
      <li><a href="classification/mixtes.php">Смешанные системы</a></li>
    </ul>
	<!-- InstanceEndEditable -->
</div>
